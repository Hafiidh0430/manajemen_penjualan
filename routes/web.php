...
Route::prefix('/jual')->middleware('CheckLevel:jual')->group(function () {
    Route::get('/',[JualController::class, 'index'])->name('jual.index');
    // Route::get('/data',[BeliController::class, 'index'])->name('beli.data');
    // Route::get('/tambah',[BeliController::class, 'tambahBeli'])->name('beli.tambah');
    // Route::post('/simpan',[BeliController::class, 'simpanBeli'])->name('beli.simpan');
});

Route::get('/stok', [StokController::class, 'index'])->middleware('CheckLevel:stok')->name('stok.index');
